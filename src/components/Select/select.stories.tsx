...
export const BMultipleSelect = (args: JSX.IntrinsicAttributes & SelectProps) => (
  <Select
    {...args}
    placeholder="支持多选欧！"
    multiple
  >
    ...
    <Select.Option value="nihao2" />
    <Select.Option value="nihao3" />
    <Select.Option value="mirage" />
    <Select.Option value="mirage2" />
  </Select>
)
BMultipleSelect.storyName = '支持多选的 Select'
export const CDisabledSelect = (args: JSX.IntrinsicAttributes & SelectProps) => (
  <Select
    {...args}
    placeholder="禁用啦！"
    disabled
