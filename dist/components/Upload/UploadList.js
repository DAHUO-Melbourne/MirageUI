...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'mirage-upload-list' }, fileList.map(function (item) {
        return (React.createElement("li", { className: "mirage-upload-list-item", key: item.uid },
