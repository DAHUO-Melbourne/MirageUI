...
function App() {
    ...
    var _c = useState(''), selectedDate = _c[0], setSelectedDate = _c[1];
    var postData = {
        title: 'my title',
        body: 'hello man',
    };
    ...
    return (React.createElement("div", { className: "App" },
        React.createElement("header", { className: "App-header" },
            React.createElement(Icon, { icon: 'arrow-up', theme: 'danger', size: '10x' }),
            React.createElement(Menu, { defaultIndex: '0', onSelect: function (index) { return alert(index); }, defaultOpenSubmenus: ['3'] },
            ...
            React.createElement(Transition, { in: show, timeout: 300, classNames: 'zoom-in-left' },
                React.createElement("div", null,
                    ...
                    React.createElement("p", null,
                        ...
                        React.createElement("code", null, "src/App.tsx"),
                        " and save to reload."))),
            React.createElement(Transition, { in: show, timeout: 300, classNames: 'zoom-in-left', wrapper: true },
                React.createElement(Button, { size: 'lg', btnType: 'primary' }, "A Large Button")),
            ...
            React.createElement(Button, { btnType: 'link', size: 'lg', href: 'https://www.google.com.au', target: '_blank' }, "Google"),
            React.createElement(Button, { btnType: 'link', size: 'lg', href: 'https://www.google.com.au', disabled: true }, "Disabled Google"),
            React.createElement("p", null,
                "Edit ",
                React.createElement("code", null, "src/App.tsx"),
                " and save to reload."),
        ...
        React.createElement(DatePicker, { title: 'date picker', selectedDate: selectedDate, onSelect: setSelectedDate })));
}
export default App;
// 测试：什么样的文件会被认为是测试文件：
